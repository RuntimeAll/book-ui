<template>
  <div class="p-2">
    ...
    <!-- 操作日志详细 -->
    <el-dialog v-model="openView" title="操作日志详细" width="700px" append-to-body>
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="请求参数：">
              <div class="max-h-[160px] overflow-auto w-full break-all">{{ form.operParam }}</div>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="返回参数：">
              <div class="max-h-[160px] overflow-auto w-full break-all">{{ form.jsonResult }}</div>
            </el-form-item>
          </el-col>
          <el-col :span="24" v-if="form.status === 1">
            <el-form-item label="异常信息：">
              <div class="max-h-[160px] overflow-auto w-full break-all text-[--el-color-danger]">{{ form.errorMsg }}</div>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
