    ...
    <el-dialog v-model="dialog.visible" :title="dialog.title" width="500px" append-to-body>
      <el-form ref="roleFormRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="菜单权限">
          <el-checkbox v-model="menuExpand" @change="handleCheckedTreeExpand($event as boolean, 'menu')">展开/折叠</el-checkbox>
    ...
    <el-dialog v-model="openDataScope" :title="dialog.title" width="500px" append-to-body>
      <el-form ref="dataScopeRef" :model="form" label-width="80px">
        ...
        <el-form-item v-show="form.dataScope === '2'" label="数据权限">
          <el-checkbox v-model="deptExpand" @change="handleCheckedTreeExpand($event as boolean, 'dept')">展开/折叠</el-checkbox>
...
import type { RoleVO, RoleForm, RoleQuery, DeptTreeOption } from '@/api/system/role/types';
...
const handleAuthUser = (row: RoleVO) => {
  router.push('/manage/role-auth/user/' + row.roleId);
};
